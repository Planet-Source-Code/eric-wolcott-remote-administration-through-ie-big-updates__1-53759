...
Public Type Connection
    ...
    Upload As String
    Type As String
    AdminStatus As String
    InterfaceIndex As String
    OutgoingErrors As String
    DiscardedIncomingPackets As String
    DiscardedOutgoingPackets As String
    IncomingErrors As String
    NonunicastPacketsReceived As String
    OctetsReceived As String
    OctetsSent As String
    UnicastPacketsReceived As String
    NonunicastPacketsSent As String
    UnknownProtocolPackets As String
    OutputQueueLength As String
    UnicastPacketsSent As String
    LastChange As String
    MaximumTransmissionUnit As String
    OperationalStatus As String
    InterfaceDescription As String
End Type
